...
**14:30–14:45** Why AI Fails to Influence Admission Decisions: Evidence from a Case Study  
*Wiesje Roskamp, Yvette J. van der Haas, Rogier L. C. Plas, Bart Overbeek, Marleen Vreeburg, Annemarie de Jong, Renata M. de Carvalho, Boudewijn F. van Dongen, Thomas van Dijk*

**14:45–15:00** Standardizing MRI Patient Setup with Real-Time Camera Guidance and Worklist-Driven Scan Intent  
*Deepa Anand, Sai Gannavarapu, Sajith Rajamani, Shriram KS, Krishna Sumanth, Kopal Dixit, Dattesh D. Shanbhag*

**15:00–15:15** Toward Agentic Echocardiography: Reinforcement Learning with Foundation-Model Similarity Rewards in a CT-Derived Simulation  
*Hyunseok Jeong, Jong-um Yoon, Seohwa Lee, Byunghwan Jeon*
...
**16:05–16:10** Adapt While You Annotate: The Missing Complement to Interactive Segmentation  
*Parhom Esmaeili, Chayanin Tangwiriyasakul, Eli Gibson, Sebastien Ourselin, M. Jorge Cardoso*

**16:10–16:15** Characterizing Global and Local Model Behavior in Interactive Segmentation  
*Daniel Kovacs-Deak, Maria Ines Meyer, Adriaan Lambrechts, Roel Wirix-Speetjens, Frederik Maes*

**16:15–16:20** Human Checkpoints in Automated Speech-to-Report Generation: Radiologist Correction for CEUS LI-RADS Categorization  
*Taewon Han, Jaeseung Shin*

**16:20–16:25** Beyond One-Shot Interaction: Framing Pathology Human–AI Collaboration via Workflow Evidence  
*Shangqin Lyu, Zeyu Liu*

**16:25–16:30** A3F: Anatomy-Aware Actionable Feedback for Fetal Ultrasound  
*Angela Feixue Wang, Hala Lamdouar, Jayne Lander, Aris T. Papageorghiou, J. Alison Noble*

**16:30–16:35** Fetal-CARE: Collaborative Annotation with Reviewer-Stratified Expertise for Fetal Ultrasound Standard Plane Classification  
*Lakshminarayanan M, Srivibha Parthasarathy, Keerthi Ram, Shyam Ayyasamy, Suresh Seshadri, Manojkumar Lakshmanan, Mohanasankar Sivaprakasam*

**16:35–16:45** Q&A for Spotlight Talks

**16:45–16:55** Awards and Concluding

### Posters

<details>
<summary>AI-assisted labeling and its pitfalls: A case study in Electron Microscopy segmentation</summary>

*Christina Bukas, Jonas Engler, Helena Pelin, Jonas Hagenberg, Haider Khan, Francesco Campi, Carola Eberhagen, Hans Zischka, Marie Piraud*

</details>

<details>
<summary>Adapt While You Annotate: The Missing Complement to Interactive Segmentation</summary>
...
<details>
<summary>Characterizing Global and Local Model Behavior in Interactive Segmentation</summary>
...
<details>
<summary>Why AI Fails to Influence Admission Decisions: Evidence from a Case Study</summary>
...
<details>
<summary>Standardizing MRI Patient Setup with Real-Time Camera Guidance and Worklist-Driven Scan Intent</summary>
...
<details>
<summary>Towards Interpretable AI Second Opinions: Foundation Model Heatmaps in Radiology</summary>

*Ethan Dack, Chengliang Dai, Hanno Hoppe, Paula Krüselmann, Stefanie Meiler, Warissara Jutidamrongphan, Ling Wang, Kun Tang*

</details>

<details>
<summary>It’s Time to Talk Human-Centered Research at MICCAI</summary>
...
<details>
<summary>A3F: Anatomy-Aware Actionable Feedback for Fetal Ultrasound</summary>
...
<details>
<summary>Learning to Defer with Guidance on Real World Medical Data</summary>
...
<details>
<summary>IBS: Interactive Batch Selection for Medical Image Segmentation</summary>

*Bernhard Föllmer, Kenrick Schulze, Marc Dewey, Hervé Delingette*

</details>

<details>
<summary>IMVS: Interactive Medical Volume Segmentation with Test-Time Adaptation - A New Method for Annotating Radiology Datasets</summary>
...
<details>
<summary>Fetal-CARE: Collaborative Annotation with Reviewer-Stratified Expertise for Fetal Ultrasound Standard Plane Classification</summary>
...
<details>
<summary>Accounting for Over-Reliance in AI-Assisted Performance Studies</summary>
...
<details>
<summary>Human Checkpoints in Automated Speech-to-Report Generation: Radiologist Correction for CEUS LI-RADS Categorization</summary>
...
<details>
<summary>Verbalized Findings as the Interface for Near-Term Human–AI Collaboration in Radiology: A Clinical Perspective on LLM-Assisted Diagnosis</summary>
...
<details>
<summary>Beyond One-Shot Interaction: Framing Pathology Human–AI Collaboration via Workflow Evidence</summary>
...
<details>
<summary>Rethinking Ultrasound Datasets via Clinical Human–AI Collaboration Tiers</summary>

*Siyuan He, Qianhui Men, Cheng Ouyang, Mathias Unberath, J. Alison Noble, Xiaoqing Guo*

</details>

<details>
<summary>Toward Agentic Echocardiography: Reinforcement Learning with Foundation-Model Similarity Rewards in a CT-Derived Simulation</summary>
...
<details>
<summary><strong>Organization Committee</strong></summary>
...
<details>
<summary><strong>Advisory Board</strong></summary>

- [Qi Dou](http://www.cse.cuhk.edu.hk/~qdou/) (Chinese University of Hong Kong)
- [Helen Higham](https://www.ndcn.ox.ac.uk/team/helen-higham) (University of Oxford)
- [Pierre Jannin](https://medicis.univ-rennes1.fr/members/pierre.jannin/index) (University of Rennes)
- [Nassir Navab](https://www.professoren.tum.de/en/navab-nassir) (Technical University of Munich)
...
<details>
<summary><strong>Industry Board</strong></summary>
...
<details>
<summary><strong>Student Board</strong></summary>
...
- Zhen Chen (Hong Kong Polytechnic University)
- Yuqi Fang (Nanjing University)
- Runlong He (University College London)
- Haojun Jiang (Tsinghua University)
- Sung Eun Kim (Harvard Medical School)
- Taeil Matthew Kim (Stanford University)
- Yunsoo Kim (University College London)
- Lisa M. Koch (Universität Bern)
- Soochahn Lee (Kookmin University)
- Haozhe Luo (University of Zurich)
- Lichao Mou (MedAI Tech.)
- Denis Parra (Pontificia Universidad Catolica de Chile)
- Can Peng (University of Oxford)
- Yi Qin (Hong Kong University of Science and Technology)
...
- Xiandi Wang (Sichuan University)
- Shuwei Xing (University of Oxford)
- Xiaoman Zhang (Shanghai Jiao Tong University)
- Zhiyuan Zhu (Nanjing University)
- Maria A Zuluaga (King's College London)
...
<div style="margin-top: 20px; text-align: center;">
  <img alt="nvidia-logo-horz" src="https://github.com/user-attachments/assets/58015356-04de-4131-b76e-d1a8e027f17f" width="300">
</div>
